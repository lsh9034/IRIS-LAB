...
predict_mode = 'once'
file_path = f'./experiments/L1_GSimVP/validate/{predict_mode}/'
...
set_name='train'
sst_valid_dataset = dataset_sst.SSTDataset(3, predict_day=7 ,img_interval=1,
                                           mode=set_name)
data, label = sst_valid_dataset[0]
T, C, H, W = label.shape
print(T,C,H,W)
model_name = 'gsimvp_10ep_imginterval_1_best.pkl'
record = torch.load('./experiments/L1_GSimVP/models/'+model_name)
